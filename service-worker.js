const CACHE='magic-ticket-shell-v5';
const SHELL=['./','./index.html','./styles.css?v=44','./app.js?v=44','./config.js','./pwa.css?v=4','./pwa.js?v=5','./admin-search.css?v=1','./admin-search.js?v=1','./magic-flight-v2.js?v=3','./manifest.webmanifest','./magic-ticket-icon.svg'];
